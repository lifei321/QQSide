...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        [tempAppDelegate.mainNavigationController1 pushViewController:VC animated:YES];

    }else if (indexPath.row == 1){
        
        [tempAppDelegate.mainNavigationController2 pushViewController:VC animated:YES];

    }else if (indexPath.row == 2){
        
        [tempAppDelegate.mainNavigationController3 pushViewController:VC animated:YES];
